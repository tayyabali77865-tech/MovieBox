...
const App = {
  ...
  async fetchAndRender() {
    ...
    try {
      ...
      this.grid.innerHTML = `<div style="grid-column: 1/-1; text-align: center; padding: 4rem; color: #666;">
          <h3>Failed to fetch ${this.currentType === 'movie' ? 'movies' : this.currentType === 'tv' ? 'TV series' : 'anime'}</h3>
